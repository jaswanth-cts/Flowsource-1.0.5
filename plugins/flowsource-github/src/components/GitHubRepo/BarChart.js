...
const BarChart = ({values, count}) => {
  ...
  const data = {
    ...
    datasets: [
      {
      backgroundColor: ['#6ed265','#ffc531','#ff7c07','#FF0000'],
      borderColor: ['#6ed265','#ffc531','#ff7c07','#FF0000'],
      borderWidth: 1,
      hoverBackgroundColor:['#6ed265','#ffc531','#ff7c07','#FF0000'],
      hoverBorderColor: ['#6ed265','#ffc531','#ff7c07','#FF0000'],
      //data: [20, 30, 15, 10],
