...
const PluginVersion = () => {
    ...
    async function getVersion() {
        try {
            ...
            const value = JSON.parse(sessionStorage.getItem('Resiliance4jBackendVersion'));
            ...
            if (value !== null && value !== 'null' && value !== undefined && value !== '-' && value !== '') {
                ...
                if (response.ok) {
                    ...
                    if (backendVersionInfo.version != null || backendVersionInfo.version != undefined) {
                        ...
                        sessionStorage.setItem('Resiliance4jBackendVersion', JSON.stringify(backendVersionInfo.version));
                    } else {
                        setBackendVersion('-');
                        sessionStorage.setItem('Resiliance4jBackendVersion', '-');
                    }
                } else {
                    setBackendVersion('-');
                    sessionStorage.setItem('Resiliance4jBackendVersion', '-');
